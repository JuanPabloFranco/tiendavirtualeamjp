...
if($action == 'ajax'){
include("conexionCantidad.php");//Contiene los datos de conexion a la base de datos
...
$categorias []= array('Mes',"Cantidad Ventas $periodo");//Nombre de la primer fila del grafico
for ($inicio = 1; $inicio <= 12; $inicio++) {
    $mes=$txt_mes[$inicio];//Obtengo la abreviatura del mes
	$ingresos=monto('venta',$inicio,$periodo);//Obtengo el  monto de los ingresos
