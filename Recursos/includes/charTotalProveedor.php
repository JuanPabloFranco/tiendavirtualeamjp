...
if($action == 'ajax'){
include("conexionTotalProveedor.php");//Contiene los datos de conexion a la base de datos
...
$categorias []= array('Proveedor',"Cantidad Pedidos $periodo");//Nombre de la primer fila del grafico
for ($inicio = 1; $inicio <= 12; $inicio++) {
    $mes=$txt_mes[$inicio];//Obtengo la abreviatura del mes
	$ingresos=montoProv('pedido_proveedor',$inicio,$periodo);//Obtengo el  monto de los ingresos
